...
{block name="bread_title"}
	...
	{/capture}
{bread_title help='' parents=$smarty.capture.parentArticle	admpage="articles" actionsAdd="" }{tr}List Articles{/tr}{/bread_title}
{/block}

<div class="t_navbar margin-bottom-md">
	<div class="col-md-8">
	{if $tiki_p_edit_article eq 'y' or $tiki_p_admin eq 'y' or $tiki_p_admin_cms eq 'y'}
		{button href="tiki-edit_article.php" _xtype="link" class="btn btn-link" _icon_name="create" _text="{tr}New Article{/tr}"}
	{/if}
	{if $prefs.feature_submissions == 'y' && $tiki_p_edit_submission == "y" && $tiki_p_edit_article neq 'y' && $tiki_p_admin neq 'y' && $tiki_p_admin_cms neq 'y'}
		{button href="tiki-edit_submission.php"  _xtype="link" class="btn btn-link" _icon_name="create" _text="{tr}New Submission{/tr}"}
	{/if}
	{if $tiki_p_read_article eq 'y' or $tiki_p_articles_read_heading eq 'y' or $tiki_p_admin eq 'y' or $tiki_p_admin_cms eq 'y'}
		{button href="tiki-view_articles.php" _xtype="link" class="btn btn-link" _icon_name="articles" _text="{tr}View Articles{/tr}"}
	{/if}
	...
	{if $tiki_p_admin eq 'y' or $tiki_p_admin_cms eq 'y'}
		{button href="tiki-admin_topics.php"  _xtype="link" class="btn btn-link" _icon_name="structure" _text="{tr}Article Topics{/tr}"}
		{button href="tiki-article_types.php"  _xtype="link" class="btn btn-link" _icon_name="structure" _text="{tr}Article Types{/tr}"}
	{/if}
</div>
