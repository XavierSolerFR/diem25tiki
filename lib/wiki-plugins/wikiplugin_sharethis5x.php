...
function wikiplugin_sharethis5x_info()
{
	return array(
		'name' => tra('ShareThis5x'),
		'documentation' => 'PluginSharethis5x',
		'description' => tra('Add a ShareThis5x button'),
		'prefs' => array( 'wikiplugin_sharethis5x' ),
		'iconname' => 'sharethis',
		'introduced' => 3,
		'tags' => array( 'basic' ),
		'params' => array(
...
function wikiplugin_sharethis5x($data, $params)
{
...
/*	// The following is the array that holds the default options for the plugin.
	...
	$headerlib->add_js('var switchTo5x=true;');
	$headerlib->add_jsfile('https://ws.sharethis.com/button/buttons.js');
	//$headerlib->add_jsfile('https://ss.sharethis.com/loader.js');
	$headerlib->add_js("stLight.options({publisher: 'f9af4939-9f01-4ee5-83a2-83b8e87dcffd', doNotHash: false, doNotCopy: false, hashAddressBar: true});");
$st="heigh:28px";
	$html ="<style>.stButton .stFb, .stButton .stTwbutton, .stButton .stMainServices {
height: 22px !important;
line-height: 20px;
}</style>";
   $html .="<span ><span class='st_sharethis_hcount' displayText='ShareThis' style='$st'></span>
<span class='st_facebook_hcount' displayText='Facebook' style='$st'></span>
<span class='st_twitter_hcount' displayText='Tweet' style='$st'></span>
<span class='st_linkedin_hcount' displayText='LinkedIn' style='$st'></span>
<span class='st_email_hcount' displayText='Email'style='$st' ></span></span>
";
*/
	//<!-- Go to www.addthis.com/dashboard to customize your tools -->
$headerlib->add_jsfile('//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-5741db3b6ed60807');
return "";
	//return $html;
